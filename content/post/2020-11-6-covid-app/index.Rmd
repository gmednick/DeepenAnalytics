...
##### The [US COVID Case Tracker App](https://biolight-informatics.shinyapps.io/covid-app/) allows one to visualize the number of cases and deaths per State over time. California, Hawaii and Florida are selected by default but you can add or remove States using the selector box in the sidebar. The interactive maps use color to show the daily cases and deaths per million people by State. Detailed information can be viewed by scrolling over the State of interest. 
...
![This is what the app looks like!](covid-app-img.png)

#### In this post, I've added a county-level case map and an animation that were not included in the reactive dashboard.
